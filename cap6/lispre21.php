...
$datos=mysql_query("SELECT * FROM preguntas where id_subsr=621",$conexion) or die ("error consulta");
?>

<center><font color="RED" size= 6>Seguridad del equipo</font></a><BR><BR>
