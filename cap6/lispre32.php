...
$datos=mysql_query("SELECT * FROM preguntas where id_subsr=632",$conexion) or die ("error consulta");
?>

<center><font color="RED" size= 6>Red de comunicacion</font></a><BR><BR>
