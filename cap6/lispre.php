...
$datos=mysql_query("SELECT * FROM preguntas where id_subsr=611",$conexion) or die ("error consulta");
?>

<center><font color="RED" size= 6>Ubicación y construcción del centro de computo</font></a><BR><BR>
