...
$datos=mysql_query("SELECT * FROM preguntas where id_subsr=623",$conexion) or die ("error consulta");
?>

<center><font color="RED" size= 6>Cuestionario de operacion</font></a><BR><BR>
