...
$datos=mysql_query("SELECT * FROM preguntas where id_subsr=614",$conexion) or die ("error consulta");
?>

<center><font color="RED" size= 6>Instalacion electrica y suministro de energia</font></a><BR><BR>
