...
$result = mysql_query("SELECT id_preg, pregunt FROM preguntas WHERE id_subsr=612", $connexion); 
...
background: #3498db;
  ...
  text-decoration: none;'
  width: 50px;' >
<a href='613.php' style='color: #fff; font-family: Verdana; font-size: medium; ' >Regresar</a></td>
...
background: #3498db;
  ...
  text-decoration: none;
  width: 50px;' >
  <a href='613.php' style='color: #fff; font-family: Verdana; font-size: medium; '>Siguiente</a></td>";
echo "</table>";echo "<p>";
