...
$datos=mysql_query("SELECT * FROM preguntas where id_subsr=622",$conexion) or die ("error consulta");
?>

<center><font color="RED" size= 6>Cuestionario de funciones criticas</font></a><BR><BR>
