...
$datos=mysql_query("SELECT * FROM preguntas where id_subsr=612",$conexion) or die ("error consulta");
?>

<center><font color="RED" size= 6>Piso elevado o camara lenta</font></a><BR><BR>
