...
<div id="cabecera">REGISTROS DE EMPRESAS AUDITADAS</div>
    <div id="texto">
<?php  
include("conexion.php");
?>
<?php
$sql="SELECT * from empresas INNER JOIN auditores ON empresas.id_audi=auditores.id_audi";
...
<tr>
	  ...
	  <th><a href="formEditEmpAuditada.php?id=<?php echo $id_emp=$row['id_emp'];?>">EDITAR</a></th>
	  <th><a href="eliminarEmpresaAuditada.php?id=<?php echo $id_emp=$row['id_emp'];?>">ELIMINAR</a></th>
