...
<div id="cabecera">EVALUACIÓN DE RECURSOS HUMANOS<br>Condiciones de trabajo</div>
    <div id="texto">
...
$result = mysql_query("SELECT id_preg, pregunt FROM preguntas WHERE id_subr=34 AND id_subsr=3423", $connexion); 
...
background: #3498db;
  ...
  text-decoration: none;'
  width: 50px;' >
<a href='subr_22.php' style='color: #fff; font-family: Verdana; font-size: medium; ' >Regresar</a></td>
...
background: #3498db;
  ...
  text-decoration: none;
  width: 50px;' >
  <a href='subr_24.php' style='color: #fff; font-family: Verdana; font-size: medium; '>Siguiente</a></td>";
echo "</table>";echo "<p>";
