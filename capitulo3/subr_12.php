...
<div id="cabecera">FUNCIONES<br>Apoyos</div>
    <div id="texto">
...
$result = mysql_query("SELECT id_preg, pregunt FROM preguntas WHERE id_subr=32 AND id_subsr=3212", $connexion); 
...
background: #3498db;
  ...
  text-decoration: none;'
  width: 50px;' >
<a href='subr_11.php' style='color: #fff; font-family: Verdana; font-size: medium; ' >Regresar</a></td>
...
background: #3498db;
  ...
  text-decoration: none;
  width: 50px;' >
  <a href='subr_13.php' style='color: #fff; font-family: Verdana; font-size: medium; '>Siguiente</a></td>";
echo "</table>";echo "<p>";
