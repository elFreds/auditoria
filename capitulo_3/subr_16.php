...
<div id="cabecera">OBJETIVOS<br>Adecuados</div>
    <div id="texto">
...
$result = mysql_query("SELECT id_preg, pregunt FROM preguntas WHERE id_subr=33 AND id_subsr=3316", $connexion); 
...
background: #3498db;
  ...
  text-decoration: none;'
  width: 50px;' >
<a href='subr_15.php' style='color: #fff; font-family: Verdana; font-size: medium; ' >Regresar</a></td>
...
background: #3498db;
  ...
  text-decoration: none;
  width: 50px;' >
  <a href='subr_17.php' style='color: #fff; font-family: Verdana; font-size: medium; '>Siguiente</a></td>";
echo "</table>";echo "<p>";
