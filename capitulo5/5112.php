...
$result = mysql_query("SELECT id_preg, pregunt FROM preguntas WHERE id_subsr=5112",$connexion); 
...
background: #3498db;
  ...
  text-decoration: none;'
  width: 50px;' >
<a href='5111.php' style='color: #fff; font-family: Verdana; font-size: medium; ' >Regresar</a></td>
