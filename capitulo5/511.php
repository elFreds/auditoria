...
$result = mysql_query("SELECT id_preg, pregunt FROM preguntas WHERE id_subsr=511", $connexion); 
...
background: #3498db;
  ...
  text-decoration: none;
  width: 50px;' >
  <a href='512.php' style='color: #fff; font-family: Verdana; font-size: medium; '>Siguiente</a></td>";
echo "</table>";echo "<p>";
