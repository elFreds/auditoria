...
$datos=mysql_query("SELECT * FROM preguntas where id_subr = 8 and id_subsr = 15 ",$conexion) or die ("error consulta");
?>
<html lang="es">
	<head>
	<title>Roger</title>
	...
	<div id="lateral">
					<div id="menu">
						<ul>
							<li><a href="intructivos_de_operacion.php">Regresar</a></li>
							<li><a href="EyFdP.php">Siguiente</a></li>
	...
	<div id="contenido">
		...
		<center><font color="black" size= 6>FORMAS DE IMPLANTACION </font></a><BR><BR>
...
<a href="formas_de_implantacion_1.php"><font color="black" size=3>Siguiente</font></a><br>
