...
$datos=mysql_query("SELECT * FROM preguntas where id_subr = 8 and id_subsr = 14 ",$conexion) or die ("error consulta");
?>
<html lang="es">
	<head>
	<title>Roger</title>
...
<a href="formas_de_implantacion.php"><font color="black" size=3>Regresar</font></a><br>
