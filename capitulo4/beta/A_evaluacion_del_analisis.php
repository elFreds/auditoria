...
$datos=mysql_query("SELECT * FROM preguntas where id_subr = 2",$conexion) or die ("error consulta");
?>

<div id="cabecera">EVALUACION DEL ANAALISIS</div>
...
<td>
<form name="datos" method="post" action="cuestionario_1.php">
</select>
...
background: #3498db;
  ...
  text-decoration: none;'
  width: 50px;' >
<a href='A_evaluacion_del_sistema.php' style='color: #fff; font-family: Verdana; font-size: medium; ' >Regresar</a></td>
...
background: #3498db;
  ...
  text-decoration: none;
  width: 50px;' >
  <a href='A_evaluacion_del_diseno_logico_del_sistema.php' style='color: #fff; font-family: Verdana; font-size: medium; '>Siguiente</a></td>";
echo "</table>";echo "<p>";
