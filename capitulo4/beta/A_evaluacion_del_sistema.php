...
$datos=mysql_query("SELECT * FROM preguntas where id_subr = 1",$conexion) or die ("error consulta");
?>

<div id="cabecera">EVALUACION DEL SISTEMA</div>
...
<form name="datos" method="post" action="registro_evaluacion_del_sistema.php">
</select>
<input type="text" name="evaluacion_sistema"/>
</td>
...
background: #3498db;
  ...
  text-decoration: none;
  width: 50px;' >
  <a href='A_evaluacion_del_analisis.php' style='color: #fff; font-family: Verdana; font-size: medium; '>Siguiente</a></td>";
echo "</table>";echo "<p>";
