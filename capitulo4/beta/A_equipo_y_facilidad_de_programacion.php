...
$datos=mysql_query("SELECT * FROM preguntas where id_subr = 9 ",$conexion) or die ("error consulta");
?>

<div id="cabecera"> EQUIPO Y FACILIDAD DE PROGRAMACION 
<p> </p>
</div>
<p>
<p>
...
background: #3498db;
  ...
  text-decoration: none;'
  width: 50px;' >
<a href='A_formas_de_implantacion.php' style='color: #fff; font-family: Verdana; font-size: medium; ' >Regresar</a></td>
...
background: #3498db;
  ...
  text-decoration: none;
  width: 50px;' >
  <a href='A_entrevista_al_usuario.php' style='color: #fff; font-family: Verdana; font-size: medium; '>Siguiente</a></td>";
echo "</table>";echo "<p>";
