...
<div id="cabecera"> CONTROL DEL DISEÑO DE SISTEMAS Y PROGRAMACION 
<p></p>
</div>
...
background: #3498db;
  ...
  text-decoration: none;'
  width: 50px;' >
<a href='A_control_de_proyectos.php' style='color: #fff; font-family: Verdana; font-size: medium; ' >Regresar</a></td>
...
background: #3498db;
  ...
  text-decoration: none;
  width: 50px;' >
  <a href='A_instructivos_de_operacion.php' style='color: #fff; font-family: Verdana; font-size: medium; '>Siguiente</a></td>";
echo "</table>";echo "<p>";
