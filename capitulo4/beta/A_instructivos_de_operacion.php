...
$datos=mysql_query("SELECT * FROM preguntas where id_subr = 7 ",$conexion) or die ("error consulta");
?>

<div id="cabecera"> INSTRUCTIVOS DE OPERACION
<p> </p>
</div>
<p>
<center><table >
...
background: #3498db;
  ...
  text-decoration: none;'
  width: 50px;' >
<a href='A_control_del_diseno_de_sistemas_y_progamacion.php' style='color: #fff; font-family: Verdana; font-size: medium; ' >Regresar</a></td>
...
background: #3498db;
  ...
  text-decoration: none;
  width: 50px;' >
  <a href='A_formas_de_implantacion.php' style='color: #fff; font-family: Verdana; font-size: medium; '>Siguiente</a></td>";
echo "</table>";echo "<p>";
