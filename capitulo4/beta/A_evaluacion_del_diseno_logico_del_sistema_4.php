...
$datos=mysql_query("SELECT * FROM preguntas where id_subr = 3 and id_subsr = 5 ",$conexion) or die ("error consulta");
?>
...
background: #3498db;
  ...
  text-decoration: none;'
  width: 50px;' >
<a href='A_evaluacion_del_diseno_logico_del_sistema_2.php' style='color: #fff; font-family: Verdana; font-size: medium; ' >Regresar</a></td>
...
background: #3498db;
  ...
  text-decoration: none;
  width: 50px;' >
  <a href='A_evaluacion_del_diseno_logico_del_sistema_6.php' style='color: #fff; font-family: Verdana; font-size: medium; '>Siguiente</a></td>";
echo "</table>";echo "<p>";
