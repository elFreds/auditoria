...
$datos=mysql_query("SELECT * FROM preguntas where id_subr = 10 ",$conexion) or die ("error consulta");
?>

<div id="cabecera"> ENTREVISTA AL USUARIO 
<p> </p>
</div>
<p>
<p>
...
background: #3498db;
  ...
  text-decoration: none;'
  width: 50px;' >
<a href='A_equipo_y_facilidad_de_programacion.php' style='color: #fff; font-family: Verdana; font-size: medium; ' >Regresar</a></td>
...
background: #3498db;
  ...
  text-decoration: none;
  width: 50px;' >
  <a href='finalizacion_de_capitulo4.php' style='color: #fff; font-family: Verdana; font-size: medium; '>Siguiente</a></td>";
echo "</table>";echo "<p>";
