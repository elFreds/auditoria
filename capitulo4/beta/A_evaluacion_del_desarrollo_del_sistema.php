...
$datos=mysql_query("SELECT * FROM preguntas where id_subr = 4 and id_subsr = 15 ",$conexion) or die ("error consulta");
?>
...
background: #3498db;
  ...
  text-decoration: none;'
  width: 50px;' >
<a href='A_evaluacion_del_diseno_logico_del_sistema_7.php' style='color: #fff; font-family: Verdana; font-size: medium; ' >Regresar</a></td>
...
background: #3498db;
  ...
  text-decoration: none;
  width: 50px;' >
  <a href='A_sistemas_distribuidos_internet_comunicacion_entre_oficinas.php' style='color: #fff; font-family: Verdana; font-size: medium; '>Siguiente</a></td>";
echo "</table>";echo "<p>";
