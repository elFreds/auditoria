...
$datos=mysql_query("SELECT * FROM preguntas where id_subr = 4 and id_subsr = 9 ",$conexion) or die ("error consulta");
?>

<div id="cabecera"> EVALUACION DEL DESARROLLO DEL SISTEMA 
<p> SISTEMAS DISTRIBUIDOS, INTERNET, COMUNICACION ENTRE OFICINAS</p>
</div>
<p>
<p>
<p>
...
background: #3498db;
  ...
  text-decoration: none;'
  width: 50px;' >
<a href='A_evaluacion_del_desarrollo_del_sistema.php' style='color: #fff; font-family: Verdana; font-size: medium; ' >Regresar</a></td>
...
background: #3498db;
  ...
  text-decoration: none;
  width: 50px;' >
  <a href='A_control_de_proyectos.php' style='color: #fff; font-family: Verdana; font-size: medium; '>Siguiente</a></td>";
echo "</table>";echo "<p>";
