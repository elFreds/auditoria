...
<html lang="es">
	...
	<div id="lateral">
					<div id="menu">
						<ul>
							<li><a href="evaluacion_del_sistema.php">Regresar</a></li>
							<li><a href="EdDLdS.php">Siguiente</a></li>
	...
	<div id="contenido">
		...
		<center><font color="black" size= 6>EVALUACIÓN DEL ANALISIS </font></a><BR><BR>
