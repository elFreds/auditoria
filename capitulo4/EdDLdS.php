...
$datos=mysql_query("SELECT * FROM preguntas where id_subr = 3 and id_subsr = 15 ",$conexion) or die ("error consulta");
?>
<html lang="es">
	<head>
	<title>Roger</title>
...
<a href="EdDLdS_1.php"><font color="black" size=3>Siguiente</font></a><br>
