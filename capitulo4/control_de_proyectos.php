...
<html lang="es">
	...
	<div id="lateral">
					<div id="menu">
						<ul>
							<li><a href="EdDdS.php">Regresar</a></li>
							<li><a href="control_del_diseno_del_sistema.php">Siguiente</a></li>
	...
	<div id="contenido">
		...
		<center><font color="black" size= 6>CONTROL DE PROYECTOS</font></a><BR><BR>
