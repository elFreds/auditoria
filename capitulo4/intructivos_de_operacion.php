...
<html lang="es">
	...
	<div id="lateral">
					<div id="menu">
						<ul>
							<li><a href="control_del_diseno_del_sistema.php">Regresar</a></li>
							<li><a href="formas_de_implantacion.php">Siguiente</a></li>
	...
	<div id="contenido">
		...
		<center><font color="black" size= 6>INSTRUCTIVOS DE OPERACION
 </font></a><BR><BR>
