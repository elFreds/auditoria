...
<html lang="es">
	...
	<div id="lateral">
					<div id="menu">
						<ul>
							<li><a href="auditar.php">Regresar</a></li>
							<li><a href="evaluacion_del_analisis.php">Siguiente</a></li>
	...
	<div id="contenido">
		...
		<center><font color="black" size= 6>EVALUACIÓN DEL SISTEMA </font></a><BR><BR>
