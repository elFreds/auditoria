...
<html lang="es">
	...
	<div id="lateral">
					<div id="menu">
						<ul>
							<li><a href="formas_de_implantacion.php">Regresar</a></li>
							<li><a href="entrevistas_a_usuarios.php">Siguiente</a></li>
	...
	<div id="contenido">
		...
		<center><font color="black" size= 6> EQUIPO Y FACILIDAD DE PROGRAMACION </font></a><BR><BR>
